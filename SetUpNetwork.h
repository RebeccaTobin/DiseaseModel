...
Set up the network as scalefree (original code allowed for multiple different networks).
...
The degrees (k) and average nearest neighbour degree (knn) of each node in the network are outputted.
